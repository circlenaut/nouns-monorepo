...
const Documentation: React.FC<DocumentationProps> = (
  props: DocumentationProps = { backgroundColor: '#FFF' },
) => {
        ...
        <Accordion flush>
            ...
            <Accordion.Body>
              <p>
                <Trans>
                  ...
                  There are no &apos;if&apos; statements or other rules
                  governing Noun trait scarcity, which makes all Nouns equally
                  rare. As of this writing, Nouns are made up of:
                </Trans>
              </p>
              <ul>
                <li>
          ...
          <Accordion.Item eventKey="7" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <p>
                <Trans>
                  &apos;Nounders&apos; are the group of ten builders that
                  initiated Nouns. Here are the Nounders:
                </Trans>
              </p>
              <ul>
                <li>
              ...
              <p>
                <Trans>
                  ...
                  Nounder&apos;s multisig to be vested and shared among the
                  founding members of the project.
                </Trans>
              </p>
              <p>
                <Trans>
                  Nounder distributions don&apos;t interfere with the cadence of
                  24 hour auctions. Nouns are sent directly to the
                  Nounder&apos;s Multisig, and auctions continue on schedule
