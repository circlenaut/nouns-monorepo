...
const StreamPaymentDateDetailsStep: React.FC<ProposalActionModalStepProps> = (
  props,
) => {
  ...
  return (
    <>
      ...
      <ModalSubTitle>
        <Trans>
          We suggest adding a buffer between when you assume the proposal to be
          executed and when the stream begins.
        </Trans>
      </ModalSubTitle>
