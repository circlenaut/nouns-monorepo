...
import type { TokenBuyerABI, TokenBuyerABIInterface } from "../TokenBuyerABI";
...
export class TokenBuyerABI__factory {
  static readonly abi = _abi;
  static createInterface(): TokenBuyerABIInterface {
    return new utils.Interface(_abi) as TokenBuyerABIInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TokenBuyerABI {
    return new Contract(address, _abi, signerOrProvider) as TokenBuyerABI;
  }
}
