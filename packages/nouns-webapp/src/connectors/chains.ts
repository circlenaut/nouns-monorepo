// Borrowed from: https://raw.githubusercontent.com/Uniswap/web3-react/main/example/chains.ts
...
const getInfuraUrlFor = (network: string): string =>
  environmentVariables.INFURA_KEY
    ? `https://${network}.infura.io/v3/${environmentVariables.INFURA_KEY}`
    : ''
const getAlchemyUrlFor = (network: string) =>
  environmentVariables.ALCHEMY_KEY
    ? `https://${network}.alchemyapi.io/v2/${environmentVariables.ALCHEMY_KEY}`
    : ''
